...
describe 'flower photo gvision descriptions' do
  ...
  it "can return all gvision descriptions" do
    get "/api/v1/#{flower_photo.user.username}/#{flower_photo.sanitized_name}/gvision_descriptions"
  ...
  it "can return one gvision_description" do        
    get "/api/v1/#{flower_photo.user.username}/#{flower_photo.sanitized_name}/gvision_descriptions/#{gvision_description_one.id}"
  ...
  it "can create new gvision_description" do
    post "/api/v1/#{flower_photo.user.username}/#{flower_photo.sanitized_name}/gvision_descriptions?name=California%20Poppy"
  ...
  it "can delete exisiting gvision_description" do
    ...
    delete "/api/v1/#{flower_photo.user.username}/#{flower_photo.sanitized_name}/gvision_descriptions/#{gvision_description_one.id}"
