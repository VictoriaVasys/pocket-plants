...
describe 'flower photo favorites' do
  ...
  it "can create new favorite" do
    post "/api/v1/users/flower_photos/#{flower_photo.id}/comments/#{flower_photo.id}/favorites?favorite=true"
  ...
  it "can delete exisiting favorite" do
    ...
    delete "/api/v1/users/flower_photos/#{flower_photo.id}/comments/#{flower_photo.id}/favorites/#{favorite_1.id}"
