class Api::V1::Users::FlowerPhotos::GvisionDescriptionsController < Api::V1::Users::BaseController
  ...
  def flower_photo
    current_user.flower_photos.find_by(assigned_name: params[:flower_photo_name])
  end
